@if (isset($header))
    <header class="bg-indigo-700 drop-shadow-2xl rounded-3xl text-white uppercase font-bold text-lg  leading-tight">
                    ...
                    <x-jet-dropdown align="right" width="48" > 
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex text-sm border-2 border-indigo-300 rounded-full focus:outline-none focus:border-white transition">
